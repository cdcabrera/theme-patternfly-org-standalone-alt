...
const fs = require('fs');
const { merge } = _require('webpack-merge');
const BundleAnalyzerPlugin = _require('webpack-bundle-analyzer').BundleAnalyzerPlugin;
const MiniCssExtractPlugin = _require('mini-css-extract-plugin');
const TerserPlugin = _require('terser-webpack-plugin');
